				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-footer align-left">
							<a href="#" @click="toggleSignIn" v-if="isSignIn == true" class="btn btn-sm btn-outline-secondary">or Sign Up</a>
							<a href="#" @click="toggleSignIn" v-else class="btn btn-sm btn-outline-secondary">or Sign In</a>
						</div>
					</div>
				</div>
			</div>
